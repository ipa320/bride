...
/**
 * This is the action bar contributor for the Rtt model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RttActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction refreshViewerAction = new Action(
			RttEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	 ...
	 * @generated
	 */
	public RttActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("rtt-settings"));
		toolBarManager.add(new Separator("rtt-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				RttEditorPlugin.INSTANCE.getString("_UI_RttEditor_menu"),
				"org.orocos.model.rttMenuID");
		...
		createChildMenuManager = new MenuManager(
				RttEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
