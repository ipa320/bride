...
/**
 * This is the item provider adapter for a {@link org.best_of_robotics.model.datatypes.IDLReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IDLReferenceItemProvider
	 ...
	 * @generated
	 */
	public IDLReferenceItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((IDLReference)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IDLReference_type") :
			getString("_UI_IDLReference_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IDLReference.class)) {
