...
/**
 * This is the item provider adapter for a {@link org.best_of_robotics.model.datatypes.GenericType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenericTypeItemProvider
	...
	protected void addTemplatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GenericType_template_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GenericType_template_feature", "_UI_GenericType_type"),
				 DatatypesPackage.Literals.GENERIC_TYPE__TEMPLATE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIncludePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GenericType_include_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GenericType_include_feature", "_UI_GenericType_type"),
				 DatatypesPackage.Literals.GENERIC_TYPE__INCLUDE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GenericType"));
	}
	...
	public String getText(Object object) {
		String label = ((GenericType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GenericType_type") :
			getString("_UI_GenericType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GenericType.class)) {
