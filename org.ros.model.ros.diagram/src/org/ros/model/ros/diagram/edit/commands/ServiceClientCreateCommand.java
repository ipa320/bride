 ...
 * @generated
 */
public class ServiceClientCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ServiceClientCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return RosBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateServiceClient_4001(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ServiceClient newElement = RosFactory.eINSTANCE.createServiceClient();
		getSource().getServiceClient().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(ServiceClient newElement,
