 ...
 * @generated
 */
public class ServiceServerNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				RosVisualIDRegistry
						.getType(org.ros.model.ros.diagram.edit.parts.ServiceServerNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ServiceServerNameEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return RosElementTypes.getImage(parserElement.eClass());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof RosTextSelectionEditPolicy) {
			((RosTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof RosTextSelectionEditPolicy) {
			((RosTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this,
					...
					RosEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
