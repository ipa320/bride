 ...
 * @generated
 */
public class RosBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected RosBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						RosVisualIDRegistry.getVisualID((View) view));
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(RosBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(RosBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				requestContextElementType);
		ICommand command = requestContextElementType.getEditCommand(request);
		request.setParameter(RosBaseEditHelper.EDIT_POLICY_COMMAND, null);
		request.setParameter(RosBaseEditHelper.CONTEXT_ELEMENT_TYPE, null);
		if (command != null) {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = RosElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = RosDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			RosDiagramEditorPlugin.getInstance().setLinkConstraints(
