 ...
 * @generated
 */
public class PublisherCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PublisherCreateCommand(CreateRelationshipRequest request,
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Publisher newElement = RosFactory.eINSTANCE.createPublisher();
		getSource().getPublisher().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Publisher newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
