 ...
 * @generated
 */
public class ServiceServerReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ServiceServerReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ServiceServer) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return RosBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistServiceServer_4003(getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return RosBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistServiceServer_4003(getLink(), source, getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getServiceServer().remove(getLink());
		getNewSource().getServiceServer().add(getLink());
	 ...
	 * @generated
	 */
	protected ServiceServer getLink() {
		return (ServiceServer) getElementToEdit();
	}
