...
public class RosNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case SubscriberEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://ros/1.0?Subscriber", RosElementTypes.Subscriber_4001); //$NON-NLS-1$
		case TopicEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://ros/1.0?Topic", RosElementTypes.Topic_2001); //$NON-NLS-1$
		case PublisherEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://ros/1.0?Publisher", RosElementTypes.Publisher_4002); //$NON-NLS-1$
		case NodeEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://ros/1.0?Node", RosElementTypes.Node_2002); //$NON-NLS-1$
		}
	...
	public String getText(View view) {
		...
		case SubscriberEditPart.VISUAL_ID:
			return getSubscriber_4001Text(view);
		case TopicEditPart.VISUAL_ID:
			return getTopic_2001Text(view);
		case PublisherEditPart.VISUAL_ID:
			return getPublisher_4002Text(view);
		case NodeEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getSubscriber_4001Text(View view) {
	 ...
	 * @generated
	 */
	private String getPublisher_4002Text(View view) {
		IParser parser = RosParserProvider.getParser(
	...
	private String getNode_2002Text(View view) {
		IParser parser = RosParserProvider.getParser(RosElementTypes.Node_2002,
				view.getElement() != null ? view.getElement() : view,
