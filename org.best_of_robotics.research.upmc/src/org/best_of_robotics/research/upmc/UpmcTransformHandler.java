package org.best_of_robotics.research.upmc;
...
public class UpmcTransformHandler extends AbstractHandler {

	public UpmcTransformHandler() {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		job.setTransformationEntry("epsilon/upmc.etl");
		job.setSourceMetaModelURI("http:///model.ecore");
