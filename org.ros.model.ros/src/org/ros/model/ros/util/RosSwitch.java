...
public class RosSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RosPackage.PACKAGE: {
				org.ros.model.ros.Package package_ = (org.ros.model.ros.Package)theEObject;
			...
			case RosPackage.TOPIC: {
				Topic topic = (Topic)theEObject;
				T result = caseTopic(topic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RosPackage.SERVICE: {
	 ...
	 * @generated
	 */
	public T casePackage(org.ros.model.ros.Package object) {
		return null;
	}
