 ...
 * <!-- end-user-doc -->
 * @see org.orocos.model.rtt.RttPackage#getPortType()
 * @model
 * @generated
 */
public enum PortType implements Enumerator {
	 ...
	 * @ordered
	 */
	VECTOR_OF_UNSIGNED_CHAR(19, "vector_of_unsigned_char",
			"std::vector<unsigened char>"),
	 ...
	 * @ordered
	 */
	VECTOR_OF_UNSIGNED_INT(20, "vector_of_unsigned_int",
	 ...
	 * @ordered
	 */
	VECTOR_OF_UNSIGNED_FLOAT(21, "vector_of_unsigned_float",
			"std::vector<unsigned float>"),
	 ...
	 * @ordered
	 */
	VECTOR_OF_UNSIGNED_DOUBLE(22, "vector_of_unsigned_double",
	 ...
	 * @ordered
	 */
	VECTOR_OF_UNSIGNED_SHORT(23, "vector_of_unsigned_short",
	 ...
	 * @ordered
	 */
	VECTOR_OF_UNSIGNED_LONG(24, "vector_of_unsigned_long",
	 ...
	 * @generated
	 */
	private static final PortType[] VALUES_ARRAY = new PortType[] { CHAR, INT,
			FLOAT, DOUBLE, SHORT, LONG, STRING, UNSIGNED_CHAR, UNSIGNED_INT,
			UNSIGNED_FLOAT, UNSIGNED_DOUBLE, UNSIGNED_SHORT, UNSIGNED_LONG,
			VECTOR_OF_CHAR, VECTOR_OF_INT, VECTOR_OF_FLOAT, VECTOR_OF_DOUBLE,
			VECTOR_OF_SHORT, VECTOR_OF_LONG, VECTOR_OF_UNSIGNED_CHAR,
			VECTOR_OF_UNSIGNED_INT, VECTOR_OF_UNSIGNED_FLOAT,
			VECTOR_OF_UNSIGNED_DOUBLE, VECTOR_OF_UNSIGNED_SHORT,
	...
	public static PortType get(int value) {
		...
		case STRING_VALUE:
			return STRING;
		case UNSIGNED_CHAR_VALUE:
			return UNSIGNED_CHAR;
		case UNSIGNED_INT_VALUE:
			return UNSIGNED_INT;
		case UNSIGNED_FLOAT_VALUE:
			return UNSIGNED_FLOAT;
		case UNSIGNED_DOUBLE_VALUE:
			return UNSIGNED_DOUBLE;
		case UNSIGNED_SHORT_VALUE:
			return UNSIGNED_SHORT;
		case UNSIGNED_LONG_VALUE:
			return UNSIGNED_LONG;
		case VECTOR_OF_CHAR_VALUE:
			return VECTOR_OF_CHAR;
		case VECTOR_OF_INT_VALUE:
			return VECTOR_OF_INT;
		case VECTOR_OF_FLOAT_VALUE:
			return VECTOR_OF_FLOAT;
		case VECTOR_OF_DOUBLE_VALUE:
			return VECTOR_OF_DOUBLE;
		case VECTOR_OF_SHORT_VALUE:
			return VECTOR_OF_SHORT;
		case VECTOR_OF_LONG_VALUE:
			return VECTOR_OF_LONG;
		case VECTOR_OF_UNSIGNED_CHAR_VALUE:
			return VECTOR_OF_UNSIGNED_CHAR;
		case VECTOR_OF_UNSIGNED_INT_VALUE:
			return VECTOR_OF_UNSIGNED_INT;
		case VECTOR_OF_UNSIGNED_FLOAT_VALUE:
			return VECTOR_OF_UNSIGNED_FLOAT;
		case VECTOR_OF_UNSIGNED_DOUBLE_VALUE:
			return VECTOR_OF_UNSIGNED_DOUBLE;
		case VECTOR_OF_UNSIGNED_SHORT_VALUE:
			return VECTOR_OF_UNSIGNED_SHORT;
		case VECTOR_OF_UNSIGNED_LONG_VALUE:
			return VECTOR_OF_UNSIGNED_LONG;
		}
		return null;
	}
