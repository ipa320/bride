 ...
 * <ul>
 *   <li>{@link org.orocos.model.rtt.impl.ConnectionPolicyImpl#getInputPort <em>Input Port</em>}</li>
 *   <li>{@link org.orocos.model.rtt.impl.ConnectionPolicyImpl#getOutputPort <em>Output Port</em>}</li>
 *   <li>{@link org.orocos.model.rtt.impl.ConnectionPolicyImpl#getBufferSize <em>Buffer Size</em>}</li>
 *   <li>{@link org.orocos.model.rtt.impl.ConnectionPolicyImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.orocos.model.rtt.impl.ConnectionPolicyImpl#getLockPolicy <em>Lock Policy</em>}</li>
 *   <li>{@link org.orocos.model.rtt.impl.ConnectionPolicyImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConnectionPolicyImpl extends EObjectImpl implements
		ConnectionPolicy {
	/**
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInputPort(InputPort newInputPort,
			NotificationChain msgs) {
		InputPort oldInputPort = inputPort;
		inputPort = newInputPort;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RttPackage.CONNECTION_POLICY__INPUT_PORT,
					oldInputPort, newInputPort);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setInputPort(InputPort newInputPort) {
		if (newInputPort != inputPort) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RttPackage.CONNECTION_POLICY__INPUT_PORT, newInputPort,
					newInputPort));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOutputPort(OutputPort newOutputPort,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					RttPackage.CONNECTION_POLICY__OUTPUT_PORT, oldOutputPort,
					newOutputPort);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOutputPort(OutputPort newOutputPort) {
		if (newOutputPort != outputPort) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RttPackage.CONNECTION_POLICY__OUTPUT_PORT, newOutputPort,
					newOutputPort));
	}
	...
	public void setBufferSize(short newBufferSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RttPackage.CONNECTION_POLICY__BUFFER_SIZE, oldBufferSize,
					bufferSize));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RttPackage.CONNECTION_POLICY__NAME, oldName, name));
	}
	...
	public void setLockPolicy(ConnectionPolicyLockPolicy newLockPolicy) {
		...
		lockPolicy = newLockPolicy == null ? LOCK_POLICY_EDEFAULT
				: newLockPolicy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RttPackage.CONNECTION_POLICY__LOCK_POLICY, oldLockPolicy,
					lockPolicy));
	}
	...
	public void setType(ConnectionPolicyType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RttPackage.CONNECTION_POLICY__TYPE, oldType, type));
	}
