...
/**
 * This is the item provider adapter for a {@link org.best_of_robotics.model.Cpf.Simple} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Simple_name_feature", "_UI_Simple_type"),
				CpfPackage.Literals.SIMPLE__NAME, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Simple_type_feature", "_UI_Simple_type"),
				CpfPackage.Literals.SIMPLE__TYPE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CpfPackage.Literals.SIMPLE__DESCRIPTION);
			childrenFeatures.add(CpfPackage.Literals.SIMPLE__VALUE);
			childrenFeatures.add(CpfPackage.Literals.SIMPLE__CHOICES);
			childrenFeatures.add(CpfPackage.Literals.SIMPLE__DEFAULTVALUE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Simple"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				CpfPackage.Literals.SIMPLE__DESCRIPTION,
				CpfFactory.eINSTANCE.createDescription()));

		newChildDescriptors.add(createChildParameter(
				CpfPackage.Literals.SIMPLE__VALUE,
				CpfFactory.eINSTANCE.createValue()));

		newChildDescriptors.add(createChildParameter(
				CpfPackage.Literals.SIMPLE__CHOICES,
				CpfFactory.eINSTANCE.createChoices()));

		newChildDescriptors.add(createChildParameter(
				CpfPackage.Literals.SIMPLE__DEFAULTVALUE,
