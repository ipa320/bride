...
/**
 * This is the item provider adapter for a {@link org.orocos.model.rtt.TaskContext} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskContextItemProvider extends ItemProviderAdapter implements
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_TaskContext_name_feature",
								"_UI_TaskContext_type"),
						RttPackage.Literals.TASK_CONTEXT__NAME, true, false,
	...
	protected void addNamespacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_TaskContext_namespace_feature",
						"_UI_TaskContext_type"),
				RttPackage.Literals.TASK_CONTEXT__NAMESPACE, true, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_TaskContext_type_feature",
								"_UI_TaskContext_type"),
						RttPackage.Literals.TASK_CONTEXT__TYPE, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/TaskContext"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_TaskContext_type")
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				RttPackage.Literals.TASK_CONTEXT__INPUT_PORT,
				RttFactory.eINSTANCE.createInputPort()));

		newChildDescriptors.add(createChildParameter(
				RttPackage.Literals.TASK_CONTEXT__OUTPUT_PORT,
				RttFactory.eINSTANCE.createOutputPort()));

		newChildDescriptors.add(createChildParameter(
				RttPackage.Literals.TASK_CONTEXT__PROPERTY,
