...
/**
 * This is the item provider adapter for a {@link org.orocos.model.rtt.Slave} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SlaveItemProvider extends ItemProviderAdapter implements
	 ...
	 * @generated
	 */
	public SlaveItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Slave"));
	}
	...
	public String getText(Object object) {
		String label = ((Slave) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Slave_type")
				: getString("_UI_Slave_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Slave.class)) {
