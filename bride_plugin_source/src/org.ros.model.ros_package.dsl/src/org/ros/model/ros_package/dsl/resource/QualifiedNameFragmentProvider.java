 ...
 *******************************************************************************/
package org.ros.model.ros_package.dsl.resource;
...
public class QualifiedNameFragmentProvider implements IFragmentProvider {
	...
	public String getFragment(EObject obj, Fallback fallback) {
		QualifiedName qualifiedName = qualifiedNameProvider
				.getFullyQualifiedName(obj);
		return qualifiedName != null ? qualifiedNameConverter
				.toString(qualifiedName) : fallback.getFragment(obj);
	}
	...
	public EObject getEObject(Resource resource, String fragment,
		...
		if (fragment != null) {
			for (Iterator<EObject> i = EcoreUtil
					.getAllContents(resource, false); i.hasNext();) {
