...
/**
 * This is the item provider adapter for a {@link org.best_of_robotics.model.datatypes.VectorType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VectorTypeItemProvider
	...
	protected void addTemplatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VectorType_template_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VectorType_template_feature", "_UI_VectorType_type"),
				 DatatypesPackage.Literals.VECTOR_TYPE__TEMPLATE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		String label = ((VectorType)object).getLabel();
		return label == null || label.length() == 0 ?
			getString("_UI_VectorType_type") :
				label + " - " + getString("_UI_VectorType_type");
	}
