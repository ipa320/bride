 ...
 * @generated
 */
public class SubscriberEditPart extends AbstractBorderItemEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new org.ros.model.ros_package.diagram.edit.policies.SubscriberItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Subscriber2Figure();
	}

	/**
	 * @generated
	 */
	public Subscriber2Figure getPrimaryShape() {
		return (Subscriber2Figure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.ros.model.ros_package.diagram.edit.parts.SubscriberNameEditPart) {
			((org.ros.model.ros_package.diagram.edit.parts.SubscriberNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureSubscriberNameFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(org.ros.model.ros_package.diagram.part.RosVisualIDRegistry
				.getType(org.ros.model.ros_package.diagram.edit.parts.SubscriberNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	static final Color THIS_FORE = new Color(null, 211, 72, 54);

	/**
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 211, 72, 54);
