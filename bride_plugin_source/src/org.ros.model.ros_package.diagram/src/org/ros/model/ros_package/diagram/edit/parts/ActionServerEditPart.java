 ...
 * @generated
 */
public class ActionServerEditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public ActionServerEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new org.ros.model.ros_package.diagram.edit.policies.ActionServerItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ActionServerFigure();
	}

	/**
	 * @generated
	 */
	public ActionServerFigure getPrimaryShape() {
		return (ActionServerFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.ros.model.ros_package.diagram.edit.parts.ActionServerNameEditPart) {
			((org.ros.model.ros_package.diagram.edit.parts.ActionServerNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureActionServerNameFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(org.ros.model.ros_package.diagram.part.RosVisualIDRegistry
				.getType(org.ros.model.ros_package.diagram.edit.parts.ActionServerNameEditPart.VISUAL_ID));
	}
	...
	public class ActionServerFigure extends ScalablePolygonShape {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureActionServerNameFigure;

		/**
		 * @generated
		 */
		public ActionServerFigure() {
		...
		private void createContents() {
			...
			fFigureActionServerNameFigure = new WrappingLabel();

			fFigureActionServerNameFigure.setText("<...>");

			this.add(fFigureActionServerNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureActionServerNameFigure() {
			return fFigureActionServerNameFigure;
		}
