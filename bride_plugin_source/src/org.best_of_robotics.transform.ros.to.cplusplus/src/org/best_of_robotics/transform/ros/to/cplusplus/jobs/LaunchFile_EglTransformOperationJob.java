...
public class LaunchFile_EglTransformOperationJob extends WorkspaceJob {

	private String transformEntryPath = "epsilon/architecture.egl";
	private IProject project;
	private InMemoryEmfModel sourceModel;

	public LaunchFile_EglTransformOperationJob(String name) {
		super(name);
	}
