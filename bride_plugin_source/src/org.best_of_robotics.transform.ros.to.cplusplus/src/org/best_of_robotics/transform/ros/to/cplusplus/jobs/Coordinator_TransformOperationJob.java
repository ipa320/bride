...
public class Coordinator_TransformOperationJob extends WorkspaceJob {

	private String transformEntryPath = "epsilon/coordinator_package.egl";
	private IProject project;
	private InMemoryEmfModel sourceModel;

	public Coordinator_TransformOperationJob(String name) {
		super(name);
	}
