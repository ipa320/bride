...
/**
 * This is the item provider adapter for a {@link org.orocos.model.rtt.ConnectionPolicy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionPolicyItemProvider extends ItemProviderAdapter implements
	...
	protected void addInputPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ConnectionPolicy_inputPort_feature",
						"_UI_ConnectionPolicy_type"),
				RttPackage.Literals.CONNECTION_POLICY__INPUT_PORT, true, false,
				true, null, null, null));
	}
	...
	protected void addOutputPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ConnectionPolicy_outputPort_feature",
						"_UI_ConnectionPolicy_type"),
				RttPackage.Literals.CONNECTION_POLICY__OUTPUT_PORT, true,
	...
	protected void addBufferSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ConnectionPolicy_bufferSize_feature",
						"_UI_ConnectionPolicy_type"),
				RttPackage.Literals.CONNECTION_POLICY__BUFFER_SIZE, true,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ConnectionPolicy_name_feature",
						"_UI_ConnectionPolicy_type"),
				RttPackage.Literals.CONNECTION_POLICY__NAME, true, false,
	...
	protected void addLockPolicyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ConnectionPolicy_lockPolicy_feature",
						"_UI_ConnectionPolicy_type"),
				RttPackage.Literals.CONNECTION_POLICY__LOCK_POLICY, true,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ConnectionPolicy_type_feature",
						"_UI_ConnectionPolicy_type"),
				RttPackage.Literals.CONNECTION_POLICY__TYPE, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/ConnectionPolicy"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ConnectionPolicy_type")
