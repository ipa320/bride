...
import org.ros.model.ros.diagram.edit.policies.ActionServerItemSemanticEditPolicy;
...
public class ActionServerEditPart extends AbstractBorderItemEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ActionServerItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActionServerNameEditPart) {
			((ActionServerNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(RosVisualIDRegistry
				.getType(ActionServerNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ActionClientEditPart) {
			types.add(RosElementTypes.Action_4003);
		}
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		...
		if (relationshipType == RosElementTypes.Action_4003) {
			types.add(RosElementTypes.ActionClient_3006);
		}
		return types;
	}
