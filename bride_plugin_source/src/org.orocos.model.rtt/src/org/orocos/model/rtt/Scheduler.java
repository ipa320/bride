 ...
 * <!-- end-user-doc -->
 * @see org.orocos.model.rtt.RttPackage#getScheduler()
 * @model
 * @generated
 */
public enum Scheduler implements Enumerator {
	 ...
	 * @generated
	 */
	private static final Scheduler[] VALUES_ARRAY = new Scheduler[] {
	 ...
	 * @generated
	 */
	public static final List<Scheduler> VALUES = Collections
	...
	public static Scheduler get(int value) {
		switch (value) {
		case ORO_SCHED_OTHER_VALUE:
			return ORO_SCHED_OTHER;
		case ORO_SCHED_RT_VALUE:
			return ORO_SCHED_RT;
		}
		return null;
	}
