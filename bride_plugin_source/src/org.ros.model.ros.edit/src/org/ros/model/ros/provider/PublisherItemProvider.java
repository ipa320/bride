...
/**
 * This is the item provider adapter for a {@link org.ros.model.ros.Publisher}
 * object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PublisherItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Publisher_name_feature", "_UI_Publisher_type"),
				RosPackage.Literals.PUBLISHER__NAME, true, false, false,
	...
	protected void addQueueSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_Publisher_queueSize_feature",
								"_UI_Publisher_type"),
						RosPackage.Literals.PUBLISHER__QUEUE_SIZE, true, false,
	...
	protected void addLatchPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Publisher_latch_feature", "_UI_Publisher_type"),
				RosPackage.Literals.PUBLISHER__LATCH, true, false, false,
	...
	protected void addEventHandlerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Publisher_eventHandler_feature",
						"_UI_Publisher_type"),
				RosPackage.Literals.PUBLISHER__EVENT_HANDLER, true, false,
	...
	protected void addMsgPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(new ItemPropertyDescriptor(
				...
				getString("_UI_Publisher_msg_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Publisher_msg_feature", "_UI_Publisher_type"),
				RosPackage.Literals.PUBLISHER__MSG, true, false, true, null,
				null, null) {
			@Override
			public Collection<?> getChoiceOfValues(Object object) {
				Publisher publisher = (Publisher) object;
				org.ros.model.ros.Package pack = (org.ros.model.ros.Package) publisher
	...
	/**
	 * This returns Publisher.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Publisher"));
	}
