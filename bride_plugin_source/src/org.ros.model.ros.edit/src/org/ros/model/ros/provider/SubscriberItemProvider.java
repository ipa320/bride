...
/**
 * This is the item provider adapter for a {@link org.ros.model.ros.Subscriber}
 * object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class SubscriberItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Subscriber_name_feature", "_UI_Subscriber_type"),
				RosPackage.Literals.SUBSCRIBER__NAME, true, false, false,
	...
	protected void addQueueSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Subscriber_queueSize_feature",
						"_UI_Subscriber_type"),
				RosPackage.Literals.SUBSCRIBER__QUEUE_SIZE, true, false, false,
	...
	protected void addEventHandlerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Subscriber_eventHandler_feature",
						"_UI_Subscriber_type"),
				RosPackage.Literals.SUBSCRIBER__EVENT_HANDLER, true, false,
	...
	protected void addMsgPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(new ItemPropertyDescriptor(
				...
				getString("_UI_Subscriber_msg_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Subscriber_msg_feature", "_UI_Subscriber_type"),
				RosPackage.Literals.SUBSCRIBER__MSG, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null) {
			@Override
			public Collection<?> getChoiceOfValues(Object object) {
				Subscriber subscriber = (Subscriber) object;
				org.ros.model.ros.Package pack = (org.ros.model.ros.Package) subscriber
						.eContainer().eContainer();
				System.out.println(pack.getName());

				List<String> strings = new ArrayList<String>(); // Copy the
				// students to a
				// temporary
				// list
	...
	protected void addEventPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Subscriber_eventPort_feature",
						"_UI_Subscriber_type"),
				RosPackage.Literals.SUBSCRIBER__EVENT_PORT, true, false, false,
				ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns Subscriber.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Subscriber"));
	}
