...
/**
 * This is the item provider adapter for a {@link org.best_of_robotics.model.Cpf.Properties} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertiesItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CpfPackage.Literals.PROPERTIES__DESCRIPTION);
			childrenFeatures.add(CpfPackage.Literals.PROPERTIES__SIMPLE);
			childrenFeatures.add(CpfPackage.Literals.PROPERTIES__SEQUENCE);
			childrenFeatures.add(CpfPackage.Literals.PROPERTIES__STRUCT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Properties"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				CpfPackage.Literals.PROPERTIES__DESCRIPTION,
				CpfFactory.eINSTANCE.createDescription()));

		newChildDescriptors.add(createChildParameter(
				CpfPackage.Literals.PROPERTIES__SIMPLE,
				CpfFactory.eINSTANCE.createSimple()));

		newChildDescriptors.add(createChildParameter(
				CpfPackage.Literals.PROPERTIES__SEQUENCE,
				CpfFactory.eINSTANCE.createSequence()));

		newChildDescriptors.add(createChildParameter(
				CpfPackage.Literals.PROPERTIES__STRUCT,
