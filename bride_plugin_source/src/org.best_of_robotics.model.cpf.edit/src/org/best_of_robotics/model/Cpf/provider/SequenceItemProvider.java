...
/**
 * This is the item provider adapter for a {@link org.best_of_robotics.model.Cpf.Sequence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				CpfPackage.Literals.SEQUENCE__NAME, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Sequence_type_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_Sequence_type_feature", "_UI_Sequence_type"),
				CpfPackage.Literals.SEQUENCE__TYPE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CpfPackage.Literals.SEQUENCE__DESCRIPTION);
			childrenFeatures.add(CpfPackage.Literals.SEQUENCE__SIMPLE);
			childrenFeatures.add(CpfPackage.Literals.SEQUENCE__STRUCT);
			childrenFeatures.add(CpfPackage.Literals.SEQUENCE__SEQUENCE);
		}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				CpfPackage.Literals.SEQUENCE__DESCRIPTION,
				CpfFactory.eINSTANCE.createDescription()));

		newChildDescriptors.add(createChildParameter(
				CpfPackage.Literals.SEQUENCE__SIMPLE,
				CpfFactory.eINSTANCE.createSimple()));

		newChildDescriptors.add(createChildParameter(
				CpfPackage.Literals.SEQUENCE__STRUCT,
				CpfFactory.eINSTANCE.createStruct()));

		newChildDescriptors.add(createChildParameter(
				CpfPackage.Literals.SEQUENCE__SEQUENCE,
