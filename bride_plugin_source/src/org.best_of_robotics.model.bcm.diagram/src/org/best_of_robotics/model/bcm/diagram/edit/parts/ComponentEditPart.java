...
public class ComponentEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new org.best_of_robotics.model.bcm.diagram.edit.policies.ComponentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new org.best_of_robotics.model.bcm.diagram.edit.policies.ComponentCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.best_of_robotics.model.bcm.diagram.edit.parts.ComponentNameEditPart) {
			((org.best_of_robotics.model.bcm.diagram.edit.parts.ComponentNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureComponentNameFigure());
			return true;
		}
		if (childEditPart instanceof org.best_of_robotics.model.bcm.diagram.edit.parts.PortEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.EAST);
			getBorderedFigure()
					.getBorderItemContainer()
					.add(((org.best_of_robotics.model.bcm.diagram.edit.parts.PortEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.best_of_robotics.model.bcm.diagram.edit.parts.PortEditPart) {
			getBorderedFigure()
					.getBorderItemContainer()
					.remove(((org.best_of_robotics.model.bcm.diagram.edit.parts.PortEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 236, 232, 223);
