...
public class ComponentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (org.best_of_robotics.model.bcm.diagram.providers.BcmElementTypes.Port_3001 == req
				.getElementType()) {
			return getGEFWrapper(new org.best_of_robotics.model.bcm.diagram.edit.commands.PortCreateCommand(
					req));
		}
