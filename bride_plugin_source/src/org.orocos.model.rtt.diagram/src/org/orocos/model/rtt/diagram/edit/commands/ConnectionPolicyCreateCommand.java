...
public class ConnectionPolicyCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof OutputPort) {
			return false;
		}
		...
		return RttBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateConnectionPolicy_4001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ConnectionPolicy newElement = RttFactory.eINSTANCE
