...
public class TaskContextEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new org.best_of_robotics.model.orocos.diagram.edit.policies.TaskContextItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new org.best_of_robotics.model.orocos.diagram.edit.policies.TaskContextCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextNameEditPart) {
			((org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureTaskContextNameFigure());
			return true;
		}
		if (childEditPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextNamespaceEditPart) {
			((org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextNamespaceEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureTaskContextNamespaceFigure());
			return true;
		}
		if (childEditPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextTypeEditPart) {
			((org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextTypeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureTaskContextTypeFigure());
			return true;
		}
		if (childEditPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextPropertiesEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigurePropertyCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextPropertiesEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextOperationsEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureOperationCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextOperationsEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.OutputPortEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.EAST);
			getBorderedFigure()
					.getBorderItemContainer()
					.add(((org.best_of_robotics.model.orocos.diagram.edit.parts.OutputPortEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.InputPortEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.WEST);
			getBorderedFigure()
					.getBorderItemContainer()
					.add(((org.best_of_robotics.model.orocos.diagram.edit.parts.InputPortEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextPropertiesEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigurePropertyCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextPropertiesEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextOperationsEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureOperationCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextOperationsEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.OutputPortEditPart) {
			getBorderedFigure()
					.getBorderItemContainer()
					.remove(((org.best_of_robotics.model.orocos.diagram.edit.parts.OutputPortEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.InputPortEditPart) {
			getBorderedFigure()
					.getBorderItemContainer()
					.remove(((org.best_of_robotics.model.orocos.diagram.edit.parts.InputPortEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextPropertiesEditPart) {
			return getPrimaryShape().getFigurePropertyCompartmentFigure();
		}
		if (editPart instanceof org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextOperationsEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(org.best_of_robotics.model.orocos.diagram.part.OrocosVisualIDRegistry
	...
	public List<IElementType> getMARelTypesOnTarget() {
		...
		types.add(org.best_of_robotics.model.orocos.diagram.providers.OrocosElementTypes.IActivityTaskContext_4002);
		return types;
	}
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == org.best_of_robotics.model.orocos.diagram.providers.OrocosElementTypes.IActivityTaskContext_4002) {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == org.best_of_robotics.model.orocos.diagram.providers.OrocosElementTypes.Property_3003) {
				return getChildBySemanticHint(org.best_of_robotics.model.orocos.diagram.part.OrocosVisualIDRegistry
						.getType(org.best_of_robotics.model.orocos.diagram.edit.parts.TaskContextPropertiesEditPart.VISUAL_ID));
			}
			if (type == org.best_of_robotics.model.orocos.diagram.providers.OrocosElementTypes.Operation_3004) {
				return getChildBySemanticHint(org.best_of_robotics.model.orocos.diagram.part.OrocosVisualIDRegistry
