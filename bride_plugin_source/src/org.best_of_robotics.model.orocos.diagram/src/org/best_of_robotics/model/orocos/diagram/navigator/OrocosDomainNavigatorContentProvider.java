 ...
 * @generated
 */
public class OrocosDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public OrocosDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof org.best_of_robotics.model.orocos.diagram.navigator.OrocosDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((org.best_of_robotics.model.orocos.diagram.navigator.OrocosDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new org.best_of_robotics.model.orocos.diagram.navigator.OrocosDomainNavigatorItem(
