 ...
 * @generated
 */
public class RttNavigatorContentProvider implements ICommonContentProvider {
	...
	public RttNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<RttNavigatorItem> result = new ArrayList<RttNavigatorItem>();
		...
		if (parentElement instanceof RttNavigatorGroup) {
			RttNavigatorGroup group = (RttNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof RttNavigatorItem) {
			RttNavigatorItem navigatorItem = (RttNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case IActivityTaskContextEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			RttNavigatorGroup target = new RttNavigatorGroup(
					Messages.NavigatorGroupName_IActivityTaskContext_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			RttNavigatorGroup source = new RttNavigatorGroup(
					Messages.NavigatorGroupName_IActivityTaskContext_4002_source,
		...
		case InputPortEditPart.VISUAL_ID: {
			LinkedList<RttAbstractNavigatorItem> result = new LinkedList<RttAbstractNavigatorItem>();
			Node sv = (Node) view;
			RttNavigatorGroup incominglinks = new RttNavigatorGroup(
					Messages.NavigatorGroupName_InputPort_3002_incominglinks,
		...
		case TaskContextEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			RttNavigatorGroup incominglinks = new RttNavigatorGroup(
					Messages.NavigatorGroupName_TaskContext_2001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					RttVisualIDRegistry.getType(OutputPortEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					RttVisualIDRegistry.getType(InputPortEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					RttVisualIDRegistry
			...
			connectedViews = getChildrenByType(connectedViews,
					RttVisualIDRegistry.getType(OperationEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					RttVisualIDRegistry
		...
		case ConnectionPolicyEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			RttNavigatorGroup target = new RttNavigatorGroup(
					Messages.NavigatorGroupName_ConnectionPolicy_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			RttNavigatorGroup source = new RttNavigatorGroup(
					Messages.NavigatorGroupName_ConnectionPolicy_4001_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					RttVisualIDRegistry.getType(InputPortEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	private Collection<RttNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<RttNavigatorItem> result = new ArrayList<RttNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new RttNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof RttAbstractNavigatorItem) {
			RttAbstractNavigatorItem abstractNavigatorItem = (RttAbstractNavigatorItem) element;
