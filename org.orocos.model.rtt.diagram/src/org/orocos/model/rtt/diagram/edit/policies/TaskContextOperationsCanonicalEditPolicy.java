...
public class TaskContextOperationsCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenList() {
		...
		List<RttNodeDescriptor> childDescriptors = RttDiagramUpdater
				.getTaskContextOperations_7003SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return OperationEditPart.VISUAL_ID == RttVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<RttNodeDescriptor> childDescriptors = RttDiagramUpdater
				.getTaskContextOperations_7003SemanticChildren((View) getHost()
						.getModel());
