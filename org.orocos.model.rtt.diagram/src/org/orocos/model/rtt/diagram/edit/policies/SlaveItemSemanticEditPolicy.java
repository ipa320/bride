 ...
 * @generated
 */
public class SlaveItemSemanticEditPolicy extends RttBaseItemSemanticEditPolicy {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (RttVisualIDRegistry.getVisualID(outgoingLink) == IActivityTaskContextEditPart.VISUAL_ID) {
