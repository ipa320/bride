 ...
 * @generated
 */
public class RttViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return PackageEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& RttVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = RttVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!RttElementTypes.isKnownElementType(elementType)
		...
		return TaskContextEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = RttVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != RttVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = RttVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = RttVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case TaskContextEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (RttVisualIDRegistry.getVisualID(elementTypeHint)) {
	...
	public Node createActivity_2002(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RttVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5011 = createLabel(node,
				RttVisualIDRegistry
						.getType(ActivityCpuAffinityEditPart.VISUAL_ID));
		Node label5012 = createLabel(node,
				RttVisualIDRegistry.getType(ActivityPeriodEditPart.VISUAL_ID));
		Node label5013 = createLabel(node,
				RttVisualIDRegistry.getType(ActivityPriorityEditPart.VISUAL_ID));
	...
	public Node createOutputPort_3001(EObject domainElement,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RttVisualIDRegistry.getType(OutputPortEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5002 = createLabel(node,
				RttVisualIDRegistry.getType(OutputPortTypeEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createInputPort_3002(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RttVisualIDRegistry.getType(InputPortEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5004 = createLabel(node,
				RttVisualIDRegistry.getType(InputPortTypeEditPart.VISUAL_ID));
		Node label5005 = createLabel(node,
				RttVisualIDRegistry
						.getType(InputPortIsEventPortEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createSlave_3004(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RttVisualIDRegistry.getType(SlaveEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Edge createConnectionPolicy_4001(EObject domainElement,
		...
		edge.setType(RttVisualIDRegistry
