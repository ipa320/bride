...
/**
 * This is the item provider adapter for a {@link org.best_of_robotics.research.brsu.comm.communicationmodel.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommunicationmodelPackage.Literals.CONNECTOR__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommunicationmodelPackage.Literals.CONNECTOR__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommunicationmodelPackage.Literals.CONNECTOR__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CommunicationmodelPackage.Literals.CONNECTOR__DISTRIBUTION);
			childrenFeatures.add(CommunicationmodelPackage.Literals.CONNECTOR__INTERACTION);
			childrenFeatures.add(CommunicationmodelPackage.Literals.CONNECTOR__TRANSPORT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CommunicationmodelPackage.Literals.CONNECTOR__DISTRIBUTION,
				 CommunicationmodelFactory.eINSTANCE.createDistribution()));

		newChildDescriptors.add
			(createChildParameter
				(CommunicationmodelPackage.Literals.CONNECTOR__DISTRIBUTION,
				 CommunicationmodelFactory.eINSTANCE.createBroker()));

		newChildDescriptors.add
			(createChildParameter
				(CommunicationmodelPackage.Literals.CONNECTOR__DISTRIBUTION,
				 CommunicationmodelFactory.eINSTANCE.createProxy()));

		newChildDescriptors.add
			(createChildParameter
				(CommunicationmodelPackage.Literals.CONNECTOR__INTERACTION,
				 CommunicationmodelFactory.eINSTANCE.createInteraction()));

		newChildDescriptors.add
			(createChildParameter
				(CommunicationmodelPackage.Literals.CONNECTOR__INTERACTION,
				 CommunicationmodelFactory.eINSTANCE.createPubSub()));

		newChildDescriptors.add
			(createChildParameter
				(CommunicationmodelPackage.Literals.CONNECTOR__INTERACTION,
				 CommunicationmodelFactory.eINSTANCE.createPeerToPeer()));

		newChildDescriptors.add
			(createChildParameter
				(CommunicationmodelPackage.Literals.CONNECTOR__TRANSPORT,
				 CommunicationmodelFactory.eINSTANCE.createTransport()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return CommunicationModelEditPlugin.INSTANCE;
	}
