 ...
 * @generated
 */
public abstract class OrocosAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = org.best_of_robotics.model.orocos.diagram.part.OrocosDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected OrocosAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
