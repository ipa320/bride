...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private org.best_of_robotics.model.orocos.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new org.best_of_robotics.model.orocos.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
