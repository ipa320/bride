 ...
 * @generated
 */
public class BcmDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public BcmDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof org.best_of_robotics.model.bcm.diagram.navigator.BcmDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((org.best_of_robotics.model.bcm.diagram.navigator.BcmDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new org.best_of_robotics.model.bcm.diagram.navigator.BcmDomainNavigatorItem(
