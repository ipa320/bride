 ...
 * <ul>
 *   <li>{@link org.best_of_robotics.model.bcm.impl.ConnectionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.best_of_robotics.model.bcm.impl.ConnectionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.best_of_robotics.model.bcm.impl.ConnectionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectionImpl extends EObjectImpl implements Connection {
	...
	protected EClass eStaticClass() {
		return BcmPackage.Literals.CONNECTION;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							BcmPackage.CONNECTION__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public Port getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							BcmPackage.CONNECTION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					BcmPackage.CONNECTION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case BcmPackage.CONNECTION__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case BcmPackage.CONNECTION__TARGET:
			if (resolve)
				return getTarget();
