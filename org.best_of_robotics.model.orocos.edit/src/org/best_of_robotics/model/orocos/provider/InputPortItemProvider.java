...
/**
 * This is the item provider adapter for a {@link org.best_of_robotics.model.orocos.InputPort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_InputPort_isEventPort_feature", "_UI_InputPort_type"),
				 OrocosPackage.Literals.INPUT_PORT__IS_EVENT_PORT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_InputPort_name_feature", "_UI_InputPort_type"),
				 OrocosPackage.Literals.INPUT_PORT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_InputPort_inputConnectionPolicy_feature", "_UI_InputPort_type"),
				 OrocosPackage.Literals.INPUT_PORT__INPUT_CONNECTION_POLICY,
				 true,
				 false,
				 true,
				 null,
