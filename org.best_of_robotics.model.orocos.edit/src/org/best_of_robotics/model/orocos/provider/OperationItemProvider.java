...
/**
 * This is the item provider adapter for a {@link org.best_of_robotics.model.orocos.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OrocosPackage.Literals.OPERATION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OrocosPackage.Literals.OPERATION__RETURN_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDocumentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_documentation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_documentation_feature", "_UI_Operation_type"),
				 OrocosPackage.Literals.OPERATION__DOCUMENTATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Operation.class)) {
			case OrocosPackage.OPERATION__NAME:
			case OrocosPackage.OPERATION__RETURN_TYPE:
			case OrocosPackage.OPERATION__DOCUMENTATION:
