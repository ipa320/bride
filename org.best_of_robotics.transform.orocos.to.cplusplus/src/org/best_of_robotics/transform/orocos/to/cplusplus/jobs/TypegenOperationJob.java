...
public class TypegenOperationJob extends WorkspaceJob {

	private String transformEntryPath = "epsilon/typegen.egl";
	private IProject project;
	private InMemoryEmfModel sourceModel;

	public TypegenOperationJob(String name) {
		super(name);
	}
	...
	public void createSource(Resource resource) {
		if (resource != null) {
			sourceModel = new InMemoryEmfModel(
					"Source", resource, OrocosPackage.eINSTANCE);
