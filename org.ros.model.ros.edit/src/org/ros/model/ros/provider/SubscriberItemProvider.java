	...
	protected void addTopicPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subscriber_topic_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subscriber_topic_feature", "_UI_Subscriber_type"),
				 RosPackage.Literals.SUBSCRIBER__TOPIC,
				 true,
				 false,
				 true,
				 null,
